...
# === jobs listing module scraper parameters ===

# on/off headless mode
headless_for_jobs_listing = True

# Links for searching jobs.
...
# Prompt for ai to decide jobs matching percentage.
...
# About me for ai to check jobs title with about me.
...
# How much previews processed jobs link should be save in db for avoid duplicate.
keep_processed_jobs_links = 8000

# Indeed account dir for jobs listing.
INDEED_ACCOUNT_DIR_FOR_JOBS_LISTING = BASE_DIR / "utils" / "in_account_for_jobs_listing"


# === Jobs details scraper module parameters ===
...
# === Parameters for application submitter module. ===
...
wait_when_app_submitted = 3  # second
